...
async function main() {
  ...
  const assamDistricts = [
    {
      slug: "dibrugarh", name: "Dibrugarh", nameLocal: "ডিব্ৰুগড়",
      tagline: "Tea City of India", population: 1326335, area: 3381,
      literacy: 76.05, sexRatio: 961, density: 392, active: true,
      talukCount: 7, villageCount: 1348, taluks: [],
    },
  ];
